<td class="text-center">
    <div class="btn-group">
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#showModal{{ $contrat->id }}">
                <i class="fas fa-eye"></i> Voir
            </a>
            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#createModal">
                <i class="fas fa-plus"></i> Créer
            </a>
            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editModal{{ $contrat->id }}">
                <i class="fas fa-edit"></i> Modifier
            </a>

            <!-- Ajoutez d'autres options ici -->
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $contrat->id }}">
...
<!-- Modals -->
@include('partials.action_contrats', ['contrat' => $contrat])
